...
void PlayerStateWalking::enter(Player & player)
{
	...
	SpritesAnimation * upperAnimation = new SpritesAnimation(upperSprites, 50);
	SpritesAnimation * lowerAnimation = new SpritesAnimation(lowerSprites, 50);
	upperAnimation->enableFlipped(_isLeft);
	lowerAnimation->enableFlipped(_isLeft);
